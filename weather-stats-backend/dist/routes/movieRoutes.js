...
exports.movieRouter.post("/getMovies", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var email, controllerResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                email = request.body.email;
                return [4 /*yield*/, movieController_1.MovieController.getUserMovies(email)];
            case 1:
